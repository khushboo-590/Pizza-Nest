        ...
        <>
            <div className="bg-[url(src/assets/images/png/Craving-bg-img.png)] bg-cover bg-center bg-no-repeat px-5 relative">
                <div className=" py-8 sm:py-10 md:py-15 lg:py-20 relative z-1">
                    ...
                    <Description className="text-white-gray max-w-[465px] text-center mx-auto pt-4" text="Your next favorite pizza is waiting. Freshly baked, flavor-packed, and delivered hot to your door — every single time." />
