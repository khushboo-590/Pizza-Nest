                            ...
                            <div className="flex flex-wrap mt-6 gap-4 sm:gap-6 lg:max-h-[135px] max-lg:justify-center">
                                {ABOUT_US_CARDS_DATA.map((obj, index) => (
                                    <div className={`${index === 1 ? "sm:mt-3" : ""}`}>
                                        <div key={index} className="bg-[#FEFEFE] border w-full min-w-[160px] sm:max-w-[170px] sm:min-w-[170px] p-3 sm:p-4.5 shadow-[0px_1px_7px_0px_#F67A211F] rounded-xl border-dashed border-orange-200 border-opacity-50">
