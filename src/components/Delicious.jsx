    ...
    return (
        <>
            <div className="px-5 py-8 sm:py-10 md:py-20 lg:py-25 relative max-w-[1920px] mx-auto">
                <img className='absolute pointer-events-none right-0 bottom-[-190px]   lg:block hidden lg:max-w-[300px] xl:max-w-[420px] animate-bounce' src={tamatoImg} alt="pizza-slice" />             
